...
- For interactive behavior the headless specs cannot see (echo area, window
  scrolling, buffer re-listing), `./tests/check-nvim-interactive.sh` drives a
  real nvim in tmux with actual keystrokes; needs tmux and installed plugins.
