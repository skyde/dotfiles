...
try {
    ...
    Set-ItemProperty -Path $keyboardRegPath -Name "KeyboardDelay" -Value "0" -ErrorAction Stop
    # Faster repeat rate (31 = fastest)
    Set-ItemProperty -Path $keyboardRegPath -Name "KeyboardSpeed" -Value "31" -ErrorAction Stop
