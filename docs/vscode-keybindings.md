...
- `Ctrl+Insert` / `Shift+Insert` / `Shift+Delete` – use standard terminal copy, paste, and cut keys in Neovim; `Ctrl+Insert` also copies the current tmux copy-mode selection.
