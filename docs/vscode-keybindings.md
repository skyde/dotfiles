...
- `Ctrl+Insert` / `Shift+Insert` / `Shift+Delete` – send standard terminal copy, paste, and cut keys. Neovim handles them mode-aware; tmux uses `Ctrl+Insert` in copy mode and `Shift+Insert` to paste into plain panes.
