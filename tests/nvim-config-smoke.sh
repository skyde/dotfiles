...
assert(rhs_for("<D-c>", "i") == [[<C-o>"+yy]])
_G.dotfiles_smoke_terminal_copy_callback = vim.fn.maparg("<D-c>", "t", false, true).callback
assert(type(_G.dotfiles_smoke_terminal_copy_callback) == "function")
...
assert(rhs_for("<D-x>", "i") == [[<C-o>"+dd]])
_G.dotfiles_smoke_terminal_cut_callback = vim.fn.maparg("<D-x>", "t", false, true).callback
assert(type(_G.dotfiles_smoke_terminal_cut_callback) == "function")
...
assert(vim.fn.maparg("\27[2;5~", "n", false, true).callback == _G.dotfiles_smoke_ctrl_insert_normal_copy_callback)
...
assert(vim.fn.maparg("\27[2;5~", "v", false, true).callback == _G.dotfiles_smoke_ctrl_insert_visual_copy_callback)
assert(rhs_for("<C-Insert>", "i") == [[<C-o>"+yy]])
assert(rhs_for("\27[2;5~", "i") == [[<C-o>"+yy]])
_G.dotfiles_smoke_ctrl_insert_terminal_copy_callback = vim.fn.maparg("<C-Insert>", "t", false, true).callback
assert(_G.dotfiles_smoke_ctrl_insert_terminal_copy_callback == _G.dotfiles_smoke_terminal_copy_callback)
assert(vim.fn.maparg("\27[2;5~", "t", false, true).callback == _G.dotfiles_smoke_ctrl_insert_terminal_copy_callback)
...
assert(vim.fn.maparg("\27[3;2~", "n", false, true).callback == _G.dotfiles_smoke_shift_delete_normal_cut_callback)
...
assert(vim.fn.maparg("\27[3;2~", "v", false, true).callback == _G.dotfiles_smoke_shift_delete_visual_cut_callback)
assert(rhs_for("<S-Del>", "i") == [[<C-o>"+dd]])
assert(rhs_for("\27[3;2~", "i") == [[<C-o>"+dd]])
_G.dotfiles_smoke_shift_delete_terminal_cut_callback = vim.fn.maparg("<S-Del>", "t", false, true).callback
assert(_G.dotfiles_smoke_shift_delete_terminal_cut_callback == _G.dotfiles_smoke_terminal_cut_callback)
assert(vim.fn.maparg("\27[3;2~", "t", false, true).callback == _G.dotfiles_smoke_shift_delete_terminal_cut_callback)
...
assert(type(_G.dotfiles_smoke_visual_paste_callback) == "function")
...
assert(vim.fn.maparg("\27[2;2~", "n", false, true).callback == _G.dotfiles_smoke_shift_insert_normal_paste_callback)
_G.dotfiles_smoke_shift_insert_visual_paste_callback = vim.fn.maparg("<S-Insert>", "v", false, true).callback
assert(_G.dotfiles_smoke_shift_insert_visual_paste_callback == _G.dotfiles_smoke_visual_paste_callback)
assert(vim.fn.maparg("\27[2;2~", "v", false, true).callback == _G.dotfiles_smoke_shift_insert_visual_paste_callback)
assert(rhs_for("<S-Insert>", "i") == "<C-r>+")
assert(rhs_for("\27[2;2~", "i") == "<C-r>+")
assert(rhs_for("<S-Insert>", "c") == "<C-r>+")
assert(rhs_for("\27[2;2~", "c") == "<C-r>+")
...
assert(vim.fn.maparg("\27[2;2~", "t", false, true).callback == _G.dotfiles_smoke_shift_insert_terminal_paste_callback)
...
;(function()
  ...
  vim.api.nvim_buf_set_lines(0, 0, -1, false, { "ctrl insert copy", "normal keep" })
  feed("gg")
  feed("<C-Insert>")
  ...
  vim.api.nvim_buf_set_lines(0, 0, -1, false, { "raw ctrl insert copy", "normal keep" })
  feed("gg")
  feed_raw("\27[2;5~")
  assert(table.concat(stored_lines, "|") == "raw ctrl insert copy|", table.concat(stored_lines, "|"))
  assert(stored_type == "V", stored_type)
  assert(lines_text() == "raw ctrl insert copy|normal keep", lines_text())
  ...
  vim.fn.setreg('"', "KEEP-NORMAL-CTRL-DELETE", "v")
  ...
  assert(vim.fn.getreg('"') == "KEEP-NORMAL-CTRL-DELETE", "normal Ctrl+Delete clobbered unnamed register")

  vim.fn.setreg('"', "KEEP-RAW-CTRL-DELETE", "v")
  ...
  assert(vim.fn.getreg('"') == "KEEP-RAW-CTRL-DELETE", "raw Ctrl+Delete clobbered unnamed register")
  ...
  vim.fn.setreg('"', "KEEP-INSERT-CTRL-DELETE", "v")
  ...
  assert(vim.fn.getreg('"') == "KEEP-INSERT-CTRL-DELETE", "insert Ctrl+Delete clobbered unnamed register")

  local insert_raw_ctrl_delete_callback = callback_for("\27[3;5~", "i")
  vim.fn.setreg('"', "KEEP-INSERT-RAW-CTRL-DELETE", "v")
  ...
  assert(vim.fn.getreg('"') == "KEEP-INSERT-RAW-CTRL-DELETE", "insert raw Ctrl+Delete clobbered unnamed register")

  vim.api.nvim_buf_set_lines(0, 0, -1, false, { "insert cmd copy", "insert keep" })
  feed("ggA")
  feed("<D-c>")
  feed("<Esc>")
  assert(table.concat(stored_lines, "|") == "insert cmd copy|", table.concat(stored_lines, "|"))
  assert(stored_type == "V", stored_type)
  assert(lines_text() == "insert cmd copy|insert keep", lines_text())

  vim.api.nvim_buf_set_lines(0, 0, -1, false, { "insert ctrl insert copy", "insert keep" })
  feed("ggA")
  feed("<C-Insert>")
  feed("<Esc>")
  assert(table.concat(stored_lines, "|") == "insert ctrl insert copy|", table.concat(stored_lines, "|"))
  assert(stored_type == "V", stored_type)
  assert(lines_text() == "insert ctrl insert copy|insert keep", lines_text())
  ...
  vim.api.nvim_buf_set_lines(0, 0, -1, false, { "shift delete cut", "normal keep", "normal tail" })
  feed("gg")
  feed("<S-Del>")
  assert(table.concat(stored_lines, "|") == "shift delete cut|", table.concat(stored_lines, "|"))
  assert(stored_type == "V", stored_type)
  assert(lines_text() == "normal keep|normal tail", lines_text())

  vim.api.nvim_buf_set_lines(0, 0, -1, false, { "raw shift delete cut", "normal keep", "normal tail" })
  feed("gg")
  feed_raw("\27[3;2~")
  assert(table.concat(stored_lines, "|") == "raw shift delete cut|", table.concat(stored_lines, "|"))
  assert(stored_type == "V", stored_type)
  assert(lines_text() == "normal keep|normal tail", lines_text())

  vim.api.nvim_buf_set_lines(0, 0, -1, false, { "insert cmd cut", "insert keep", "insert tail" })
  feed("ggA")
  feed("<D-x>")
  feed("<Esc>")
  assert(table.concat(stored_lines, "|") == "insert cmd cut|", table.concat(stored_lines, "|"))
  assert(stored_type == "V", stored_type)
  assert(lines_text() == "insert keep|insert tail", lines_text())

  vim.api.nvim_buf_set_lines(0, 0, -1, false, { "insert shift delete cut", "insert keep", "insert tail" })
  feed("ggA")
  feed("<S-Del>")
  feed("<Esc>")
  assert(table.concat(stored_lines, "|") == "insert shift delete cut|", table.concat(stored_lines, "|"))
  assert(stored_type == "V", stored_type)
  assert(lines_text() == "insert keep|insert tail", lines_text())

  vim.api.nvim_buf_set_lines(0, 0, -1, false, { "copy me", "keep" })
  feed("gg0ve")
  feed("<C-Insert>")
  feed("<Esc>")
  assert(table.concat(stored_lines, "|") == "copy", table.concat(stored_lines, "|"))
  assert(stored_type == "v", stored_type)
  assert(lines_text() == "copy me|keep", lines_text())
  ...
  vim.api.nvim_buf_set_lines(0, 0, -1, false, { "delete me", "keep" })
  feed("gg0ve")
  feed("<S-Del>")
  feed("<Esc>")
  assert(table.concat(stored_lines, "|") == "delete", table.concat(stored_lines, "|"))
  assert(lines_text() == " me|keep", lines_text())
  ...
  feed("gg0")
  feed_raw("\27[2;2~")
  assert(lines_text() == "aRAWb", lines_text())
  ...
  local terminal_visual_output = vim.fn.tempname()
  vim.cmd("enew")
  local terminal_visual_buf = vim.api.nvim_get_current_buf()
  local terminal_visual_job =
    vim.fn.termopen({ "sh", "-c", 'printf "terminal visual selection\\n"; cat > "$1"', "sh", terminal_visual_output })
  assert(type(terminal_visual_job) == "number" and terminal_visual_job > 0, "terminal-visual job did not start")
  assert(vim.wait(1000, function()
    return table.concat(vim.api.nvim_buf_get_lines(terminal_visual_buf, 0, -1, false), "\n"):find(
      "terminal visual selection",
      1,
      true
    ) ~= nil
  end), "terminal visual selection text did not appear")
  stored_lines = { "terminal visual command-v", "" }
  stored_type = "V"
  feed("gg0v$<D-v>")
  local terminal_visual_paste_output = ""
  assert(vim.wait(1000, function()
    if vim.fn.getfsize(terminal_visual_output) <= 0 then
      return false
    end
    terminal_visual_paste_output = table.concat(vim.fn.readfile(terminal_visual_output), "|")
    return terminal_visual_paste_output == "terminal visual command-v"
  end), terminal_visual_paste_output)
  stored_lines = { "terminal visual shift-insert", "" }
  stored_type = "V"
  feed("gg0v$<S-Insert>")
  assert(vim.wait(1000, function()
    terminal_visual_paste_output = table.concat(vim.fn.readfile(terminal_visual_output), "|")
    return terminal_visual_paste_output == "terminal visual command-v|terminal visual shift-insert"
  end), terminal_visual_paste_output)
  print("nvim-terminal-visual-mode-paste-ok")
  vim.fn.chanclose(terminal_visual_job, "stdin")
  vim.fn.jobwait({ terminal_visual_job }, 1000)
  if vim.api.nvim_buf_is_valid(original_buf) then
    vim.api.nvim_set_current_buf(original_buf)
  end
  if vim.api.nvim_buf_is_valid(terminal_visual_buf) then
  ...
  vim.cmd("normal! gg0")
  vim.cmd("startinsert")
  _G.dotfiles_smoke_terminal_copy_callback()
  assert(table.concat(stored_lines, "|") == "terminal cut line|", table.concat(stored_lines, "|"))
  assert(stored_type == "V", stored_type)
  assert(
    table.concat(vim.api.nvim_buf_get_lines(terminal_cut_buf, 0, -1, false), "|") == terminal_cut_before,
    "terminal-mode copy modified scrollback"
  )
  stored_lines = {}
  stored_type = ""
  _G.dotfiles_smoke_terminal_cut_callback()
  assert(table.concat(stored_lines, "|") == "terminal cut line|", table.concat(stored_lines, "|"))
  assert(stored_type == "V", stored_type)
  assert(
    table.concat(vim.api.nvim_buf_get_lines(terminal_cut_buf, 0, -1, false), "|") == terminal_cut_before,
    "terminal-mode cut modified scrollback"
  )
...
try:
    ...
    local visual_bracketed_output = vim.fn.tempname()
    local visual_bracketed_ready = vim.fn.tempname()
    vim.cmd("enew")
    local visual_bracketed_buf = vim.api.nvim_get_current_buf()
    local visual_bracketed_command = "OUT="
      .. vim.fn.shellescape(visual_bracketed_output)
      .. " READY="
      .. vim.fn.shellescape(visual_bracketed_ready)
      .. " python3 "
      .. vim.fn.shellescape(bracketed_script)
    local visual_bracketed_job = vim.fn.termopen(visual_bracketed_command)
    assert(
      type(visual_bracketed_job) == "number" and visual_bracketed_job > 0,
      "terminal-visual bracketed job did not start"
    )
    assert(vim.wait(1000, function()
      return vim.fn.filereadable(visual_bracketed_ready) == 1
    end), "terminal-visual bracketed terminal did not become ready")
    stored_lines = { "visual bracketed terminal", "" }
    stored_type = "V"
    feed("v<D-v>")
    local visual_bracketed_hex = ""
    local expected_visual_bracketed_hex = ("\027[200~visual bracketed terminal\n\027[201~"):gsub(
      ".",
      function(char)
        return string.format("%02x", string.byte(char))
      end
    ...
    assert(vim.wait(1000, function()
      if vim.fn.getfsize(visual_bracketed_output) <= 0 then
        return false
      end
      visual_bracketed_hex = table.concat(vim.fn.readfile(visual_bracketed_output), "")
      return visual_bracketed_hex == expected_visual_bracketed_hex
    end), visual_bracketed_hex)
    print("nvim-terminal-visual-bracketed-paste-ok")
    vim.fn.jobwait({ visual_bracketed_job }, 1000)
    ...
    if vim.api.nvim_buf_is_valid(visual_bracketed_buf) then
      vim.api.nvim_buf_delete(visual_bracketed_buf, { force = true })
    end
    ...
    vim.fn.delete(visual_bracketed_output)
    vim.fn.delete(visual_bracketed_ready)
