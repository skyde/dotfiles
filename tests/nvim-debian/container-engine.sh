...
# Populate container_engine_kind, podman_rootless, engine_security_options,
# and engine_server_metadata for either a native CLI or a Docker-compatible
# client. Podman's Docker API exposes "Podman Engine" in the server component
# metadata and reports rootless mode through SecurityOptions.
