...
behavior_cases = [
    ...
    ("mosh remote shell", "mosh devbox"),
    ("mosh remote nvim", "mosh devbox nvim README.md"),
    ("mosh option separator remote nvim", "mosh -- devbox nvim README.md"),
    ("mosh remote one shot", "mosh devbox echo nvim"),
    ("mosh option separator remote one shot", "mosh -- devbox echo nvim"),
    ("mosh ssh option remote nvim", "mosh --ssh='ssh -p 2222' devbox nvim README.md"),
    ("mosh server option one shot", "mosh --server=/usr/bin/mosh-server devbox echo nvim"),
    ("mosh predict option one shot", "mosh --predict=never devbox echo nvim"),
    ("mosh port option remote nvim", "mosh -p 60000 devbox nvim README.md"),
    ("mosh compact port option one shot", "mosh -p60000 devbox echo nvim"),
