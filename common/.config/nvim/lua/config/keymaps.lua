...
map("i", "<C-Insert>", '<C-o>"+yy', { desc = "Copy line" })
...
map("i", "<S-Del>", '<C-o>"+dd', { desc = "Cut line" })
...
map("v", "<S-Insert>", paste_clipboard_visual, { desc = "Paste over selection" })
map("i", "<S-Insert>", "<C-r>+", { desc = "Paste" })
map("c", "<S-Insert>", "<C-r>+", { desc = "Paste" })
map("t", "<S-Insert>", paste_clipboard_to_terminal, { desc = "Paste" })
